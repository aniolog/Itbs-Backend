    ...
    public class FotoController : ApiController
    {
        ...
        public async Task<object> upload()
        {
            ...
            try
            {
                ...
                var logic = new Logic.LogicUser();
                var user = (new Logic.LogicUser()).GetUser(HttpContext.Current.User.Identity.Name);
                user.Foto = DateTime.Now.ToString("dd-MM-yyyy-HH-mm-ss") + provider.FormData["flowFilename"];
